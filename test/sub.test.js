...
describe( `.sub`, () => {
    ...
    describe( `.sub()`, () => {
        c.itShouldExistAsStaticMethod( 'sub' )
        it.each( [
    ...
    describe( `.subn()`, () => {
        ...
        c.itShouldExistAsStaticMethod( 'subn' )
    ...
    describe( `.prototype.subn()`, () => {

        c.itShouldExistAsPrototypeMethod( 'subn' )
        ...
        it.each( [
            ...
            [c.i3, [new vec( -1, -1, -1 )], new vec( 2, 2, 2 )],
            [c.i2, [[c.i3], c.zero, new vec( 2, 3, 5 )], new vec( -2, -3, -6 )]
        ] )( `subtracting all of %j should return a single vector %j`, ( v, vecs, e ) => {
            const a = v.subn( vecs )
            expect( a ).toEqual( e )
        } )
    } )
